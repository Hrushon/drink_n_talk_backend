...
+ _предпочтительный градус напитков (degree): ***0*** - безалкогольные, ***1*** - слабоалкогольные, ***2*** - крепкие_
...
+ _градус напитков (degree) на баре: ***0*** - безалкогольные, ***1*** - слабоалкогольные, ***2*** - крепкие (по умолчанию используется значение из настроек пользователя-инициатора или градуса напитка, который он указал, что пьет в данный момент)_
